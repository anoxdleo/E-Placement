            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a class="page-scroll" href="../Profilers/Login/index.php">Login</a>
                        </li>
                        <li>
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    <h1>About Us</h1>
                    <hr>
                    <p>The aim of our project is to manages placement activities in college. Our project
provides the facility of maintain the details of students and other users.</p>
